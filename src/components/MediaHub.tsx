...
const channels = [
  {
    platform: "YouTube",
    handle: "@CognitionAI",
    url: "https://www.youtube.com/@CognitionAI",
    color: "#FF0000",
    icon: (
    ...
    description: "Watch demos, deep dives, and product announcements",
  },
  {
    platform: "LinkedIn",
    handle: "Cognition",
    url: "https://www.linkedin.com/company/cognition-ai/",
    color: "#0A66C2",
    icon: (
      <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
    ...
    description: "Follow for company updates, hiring, and thought leadership",
  },
];
...
const featuredContent = [
  {
    ...
    description: "See Devin plan, code, debug, and deploy autonomously across real-world engineering tasks.",
    thumbnail: "🎬",
    url: "https://www.youtube.com/@CognitionAI",
    platform: "YouTube",
  ...
  {
    type: "video",
    title: "Devin on SWE-bench: Industry-Leading Performance",
    description: "How Devin achieves state-of-the-art results on the most rigorous software engineering benchmarks.",
    thumbnail: "📊",
    url: "https://www.youtube.com/@CognitionAI",
    platform: "YouTube",
    platformColor: "#FF0000",
  ...
  {
    type: "article",
    title: "Why We Built Cognition",
    description: "The founding story: why autonomous AI engineers are the next frontier in software development.",
    thumbnail: "📝",
    url: "https://www.linkedin.com/company/cognition-ai/",
    platform: "LinkedIn",
  ...
  {
    type: "video",
    title: "Inside Devin's Reasoning Engine",
    description: "A technical deep dive into how Devin reasons across codebases, plans multi-step implementations, and learns from feedback.",
    thumbnail: "🧠",
    url: "https://www.youtube.com/@CognitionAI",
    platform: "YouTube",
    platformColor: "#FF0000",
  ...
  {
    type: "article",
    title: "Scaling Engineering with AI",
    description: "How enterprises are deploying Devin as institutional engineering capacity across strategic programmes.",
    thumbnail: "🏗️",
    url: "https://www.linkedin.com/company/cognition-ai/",
    platform: "LinkedIn",
    platformColor: "#0A66C2",
  ...
  {
    type: "video",
    title: "Fleet Orchestration: Devin Leading Devins",
    description: "Watch a lead Devin decompose a large initiative and coordinate multiple Devin instances in parallel.",
    thumbnail: "🤖",
    url: "https://www.youtube.com/@CognitionAI",
    platform: "YouTube",
    platformColor: "#FF0000",
      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-4xl sm:text-5xl md:text-6xl font-semibold tracking-tight max-w-3xl mx-auto leading-[1.1]">
            {"See it in action.".split(" ").map((word, i) => (
              <motion.span
                key={i}
          ...
          >
            Demos, deep dives, and the latest from the team building the future of software engineering.
          </motion.p>
        </div>
          ...
          {channels.map((channel, i) => (
            ...
            >
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs text-[#666] mt-0.5">{channel.description}</p>
              </div>
              <svg
